                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                            ...
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                @endif
                                <form action="{{'/rs-pass/'.$email}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label class="form-label" for="username">Password</label>
                                        <input type="text" id="username" name="password" class="form-control form-control-lg"  required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="username">New Password</label>
                                        <input type="text" id="username" name="new-Password" class="form-control form-control-lg"  required>
                                    </div>
