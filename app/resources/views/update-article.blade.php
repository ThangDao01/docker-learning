                                ...
                                <div class="panel-content">
                                    <form action="/article/update/{{ $article->id }}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="thumbnail" value="{{ $article->thumbnail }}"
                                                   class="form-control form-control-sm">
                                        </div>
                                        <div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="example-input-normal" value="{{ $article->description }}"
                                                   name="description"
                                                   class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="ckeditor">Detail</label>
                                            <textarea class="form-control" name="detail" id="ckeditor"
                                                      rows="5">{{ $article->detail }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-input-large" class="form-label">Source (can null)</label>
                                            <input type="text" id="example-input-large" name="source"
                                                   class="form-control form-control-lg" value="{{ $article->source }}">
                                        </div>
